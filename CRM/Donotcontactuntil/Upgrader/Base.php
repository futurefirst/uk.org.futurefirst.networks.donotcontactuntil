 ...
 */
class CRM_Donotcontactuntil_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Donotcontactuntil_Upgrader(
        'uk.org.futurefirst.networks.donotcontactuntil',
        realpath(__DIR__ .'/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Donotcontactuntil_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
